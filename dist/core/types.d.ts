...
export type AssertionType = 'contains' | 'not_contains' | 'regex' | 'json_schema' | 'llm_judge' | 'similarity' | 'sentiment' | 'toxicity' | 'starts_with' | 'ends_with' | 'length' | 'word_count' | 'cost_under' | 'latency_under' | 'snapshot' | 'ttft_under' | 'tokens_per_second_above' | 'hallucination' | 'faithfulness' | 'pii_detection' | 'prompt_injection' | 'tool_call' | 'no_refusal' | 'language' | 'coherence' | 'custom';
